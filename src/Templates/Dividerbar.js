...
function DividerBar() {
    return(
        <div>
            <Box mt={13} sx={{justifyContent:"center", height:"303px", color:"white", backgroundColor:"rgba(42, 86, 159, 0.95);", display:"grid", gridGap:"0px", gridTemplateColumns: "0.2fr 0.17px 0.2fr 0.17px 0.2fr 0.17px 0.2fr", alignItems:"center"}}>
